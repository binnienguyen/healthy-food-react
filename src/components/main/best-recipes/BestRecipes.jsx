import './BestRecipesStyle.css';
import './ResponsiveBestRecipes.css';
import {RecipePost} from './post/Post';
        ...
        <section className="bRecipes">
            <div className="recipes">
                <div className="infos">
                    ...
                    <p>Far far away, behind the word mountains, far from the countries Vakalia and Consonantia, there
